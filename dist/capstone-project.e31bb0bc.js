...
var _default = function _default(links) {
  return "\n    <nav>\n        <div class=\"logo\">\n            <h4>Marco Polo</h4>\n        </div>\n        <ul class=\"nav-links\" id=\"nav-links\">\n            ".concat(links.map(function (link) {
    return "<li><a href=\"/".concat(link, "\" data-navigo>").concat(link.title, "</a></li>");
  }).join(), "\n        </ul>\n        <div class=\"burger\">\n            <div class=\"line1\"></div>\n            <div class=\"line2\"></div>\n            <div class=\"line3\"></div>\n        </div>\n    </nav>");
};

exports.default = _default;
},{".":"components/index.js"}],"components/views/Home.js":[function(require,module,exports) {
"use strict";
...
function render(st) {
  ...
  console.log(root.querySelector("nav")); // addNavEventListeners();
}
...
var navSlide = function navSlide() {
  ...
  burger.addEventListener('click', function () {
    ...
    console.log("'BEEEEEEEEP' -HAMBURGER"); // Animate the links inside nav
    ...
    navLinks.forEach(function (link, index) {
      if (link.style.animation) {
        ...
        link.style.animation = "navLinkFade 0.5s ease forwards ".concat(index / 4 + 0.6, "s");
      }
    }); //Burger changes
